...
static unsigned int timeout_ms = 10000;
...
static const char * const default_ss_policy =
	"{"
	  ...
	  "\"certs\": [" /* named individual certificates in BASE64 DER */
		/*
		 * Globalsign CA R2... expires Dec 15 2021
		 */
		"{\"globalsign_ca_r2\": \""
	  ...
	  "\"s\": ["
		...
		"{\"h3test\": {"
			...
			"\"opportunistic\":"	"true,"
			"\"retry\":"		"\"default\","
			"\"tls_trust_store\":"	"\"goog_via_gs_r2\""
                "}}"
	"]}"
;
...
int main(int argc, const char **argv)
{
	...
	lwsl_user("LWS h3 secure streams test client [-d<verb>]\n");
